...
JustOnes = datetime.datetime.strptime(str(year+"-"+month+"-"+"10"+"T"+"23"+":"+"50"+":"+"10"), '%Y-%m-%dT%H:%M:%S')

sched.add_job(createGruopSecond, trigger='date', next_run_time=JustOnes)

FirstMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"50"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
SecondMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"51"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
ThirdMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"52"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
FoursMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"53"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
FivesMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"54"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
SixesMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"55"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
EightsMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"56"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
SevensMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"57"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
NinesMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"58"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
TensMessageTime = datetime.datetime.strptime(str(year+"-"+month+"-"+day+"T"+"18"+":"+"59"+":"+"20"), '%Y-%m-%dT%H:%M:%S')
